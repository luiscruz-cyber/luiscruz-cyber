...
**What I'm working on**
- 🤖 AI-assisted GRC: control mapping, policy generation, and audit evidence structuring with LLMs
- 🔍 Automation for vulnerability management and SOC workflows (Python, APIs, Splunk, Azure)
- 📚 Sharpening my prompt engineering and agentic-workflow skills for security use cases

**Toolbox:** `Python` `Splunk` `Azure` `Cribl` `SQL` `PowerShell` `CI/CD` `Claude` `ChatGPT`

**Open to roles** in security engineering, GRC automation, or AI-for-security.
